...
if __name__ == '__main__':
    ...
    # save results
    np.save("../data/SW_sqrt/manufactored/manufactored_solution_u_" + str(Nx) + "FD_" + str(fd_order) + ".npy", sol_midpoint)
    np.save("../data/SW_sqrt/manufactored/manufactored_solution_t_" + str(Nx) + "FD_" + str(fd_order) + ".npy", t_vec)
