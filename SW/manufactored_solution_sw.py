"""Manufactored Solution Module SW formulation solved via Vlasov-Poisson
...
from SW_sqrt.manufactored_solution_sw_sqrt import linear_rhs
...
if __name__ == '__main__':
    ...
    # save results
    np.save("../data/SW/manufactored/manufactored_solution_u_" + str(Nx) + "FD_" + str(fd_order) + ".npy", sol_midpoint)
    np.save("../data/SW/manufactored/manufactored_solution_t_" + str(Nx) + "FD_" + str(fd_order) + ".npy", t_vec)
